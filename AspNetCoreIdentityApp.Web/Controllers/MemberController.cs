    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> UserEdit(UserEditViewModel request)
        {
            ...
            if (request.Picture != null && request.Picture.Length > 0)
            {
                ...
                var newPicturePath = Path.Combine(wwwrootFolder!.First(x => x.Name == "userphotos").PhysicalPath!, randomFileName);
        ...
        [Authorize(Policy = "CampaignPolicy")]
        [HttpGet]
        public IActionResult CampaignPage()
        {
            return View();
        }
